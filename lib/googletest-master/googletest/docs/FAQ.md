...
class FooTest : public ::testing::Test {
 protected:
  ...
  T1 get_private_member1(Foo* coordinate) {
    return coordinate->private_member1_;
  }
};
...
TEST_F(YourClassTest, DoSomethingTest) {
  TestableYourClass coordinate;
  assertEquals(expected_value, coordinate.DoSomethingReturningInt());
}
```
