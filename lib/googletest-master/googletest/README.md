...
This will generate an error that looks something like the following:
    gtest.lib(gtest-all.coordinate) : error LNK2038: mismatch detected for 'RuntimeLibrary': value 'MTd_StaticDebug' doesn't match value 'MDd_DynamicDebug' in main.coordinate
